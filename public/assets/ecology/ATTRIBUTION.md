...
production-shaped placeholders pending real art.

License for every file in this directory: project-owned (BikeBrowser
project, MIT-aligned). No third-party assets are bundled.

| File                              | Source                  | Author           | License        | Notes                                  |
|-----------------------------------|-------------------------|------------------|----------------|----------------------------------------|
| plants/creosote.png               | original project asset  | local generation | project-owned  | placeholder pending real art           |
| plants/saguaro.png                | original project asset  | local generation | project-owned  | placeholder pending real art           |
| plants/mesquite.png               | original project asset  | local generation | project-owned  | placeholder pending real art           |
| plants/prickly_pear.png           | original project asset  | local generation | project-owned  | placeholder pending real art           |
| plants/barrel_cactus.png          | original project asset  | local generation | project-owned  | placeholder pending real art           |
| plants/jojoba.png                 | original project asset  | local generation | project-owned  | placeholder pending real art           |
| plants/agave.png                  | original project asset  | local generation | project-owned  | placeholder pending real art           |
...
| animals/coyote.png                | original project asset  | local generation | project-owned  | placeholder pending real art           |
| animals/roadrunner.png            | original project asset  | local generation | project-owned  | placeholder pending real art           |
...
| terrain/desert_ground.png         | original project asset  | local generation | project-owned  | tileable; placeholder pending real art |

Transformations applied: SVG drawn in code -> sharp rasterize at 128x128
-> PNG (compression level 9, alpha preserved). No external images,
fonts, or copyrighted material were used.
