export const act1Characters = [
  ...
  { id: 'dex', displayName: 'Dex', role: 'rival', location: 'street', languageProfile: ['English'], trustState: 'rival', dialogueSets: ['dex_intro', 'dex_bridge', 'dex_respect'], notebookHooks: [], questHooks: [] },
