...
export default class DialogueScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.panel = this.add.container(170, 560).setScrollFactor(0).setDepth(1200).setVisible(false);
    const bg = this.add.rectangle(0, 0, 940, 118, 0xfff0c7, 0.96).setOrigin(0, 0);
    ...
    this.hint = this.add.text(760, 90, 'E / click', {
      fontFamily: 'Arial',
      fontSize: '13px',
      color: '#6b4a33',
    });
